...
call +SugarCRM::User.find(1)+.  There is also support for collections à la +SugarCRM::User.find(1).contacts+.  
...
== SYNOPSIS:
  ...
  SugarCRM::Account.find_by_name("JAB Funds Ltd.").first.contacts.each do |contact|
